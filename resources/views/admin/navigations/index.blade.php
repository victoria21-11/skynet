...
<navigations-index inline-template>
    <div class="card">
        ...
        <div class="card-body">
            ...
            @include('admin.navigations.filters')
            ...
            <div class="table-responsive table-hover mb-3">
                <table class="table">
                    <thead>
                        <tr>
                            <th class="sort" @click="sort($event, 'id')">@lang('admin.navigations.columns.id')</th>
                            <th>@lang('admin.navigations.columns.title')</th>
                            <th>@lang('admin.navigations.columns.published')</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
