...
<social-networks-index inline-template>
    <div class="card">
        ...
        <div class="card-body">
            ...
            @include('admin.social_networks.filters')
            <div class="table-responsive table-hover mb-3">
                <table class="table">
                    <thead>
                        <tr>
                            <th class="sort" @click="sort($event, 'id')">@lang('admin.social_networks.columns.id')</th>
                            <th>@lang('admin.social_networks.columns.title')</th>
                            <th>@lang('admin.social_networks.columns.link')</th>
                            <th>@lang('admin.social_networks.columns.published')</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
