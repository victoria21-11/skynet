<div class="mb-3">
    <div class="row">
        ...
        <div class="col-auto">
            <button type="button" class="btn btn-warning" @click="clearFilters">@lang('admin.clear')</button>
        </div>
        <div class="col-auto">
            <button type="button" class="btn btn-primary" @click="getData">@lang('admin.search')</button>
        </div>
    </div>
</div>
