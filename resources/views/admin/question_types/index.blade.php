...
<question-types-index inline-template>
    <div class="card">
        ...
        <div class="card-body">
            ...
            @include('admin.question_types.filters')
            <div class="table-responsive table-hover mb-3">
                <table class="table">
                    <thead>
                        <tr>
                            <th class="sort" @click="sort($event, 'id')">@lang('admin.question_types.columns.id')</th>
                            <th>@lang('admin.question_types.columns.title')</th>
                            <th>@lang('admin.question_types.columns.published')</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
