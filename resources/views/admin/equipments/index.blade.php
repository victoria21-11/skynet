...
<equipments-index inline-template>
    <div class="card">
        ...
        <div class="card-body">
            ...
            @include('admin.equipments.filters')
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('admin.equipments.columns.installment_period')</th>
                            <th>@lang('admin.equipments.columns.published')</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="item in paginatedData.data">
                            ...
                            <td>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" :id="'installment_' + item.id" v-model="item.published">
