...
<jobopenings-index inline-template>
    <div class="card">
        ...
        <div class="card-body">
            ...
            @include('admin.jobopenings.filters')
            <div class="table-responsive table-hover mb-3">
                <table class="table">
                    <thead>
                        <tr>
                            <th class="sort" @click="sort($event, 'id')">@lang('admin.jobopenings.columns.id')</th>
                            <th>@lang('admin.jobopenings.columns.title')</th>
                            <th>@lang('admin.jobopenings.columns.published')</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
