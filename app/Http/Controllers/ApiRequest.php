...
class ApiRequest {
    ...
    const SKNT_API_URL = 'https://php73.bober.sknt.ru/kotelnikov/bill_www_master_3/genisys.sknt.ru/root/sknt';
    const SKNT_API_VERSION = '0.2';

    private $api_url = self::SKNT_API_URL;
    private $api_version = self::SKNT_API_VERSION;
